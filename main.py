...
from fetch_invoices.data_processing import organize_invoices_by_client, add_payment_details_to_invoices
...
if __name__ == "__main__":
    ...
    organized_invoices = organize_invoices_by_client(invoices)
    ...
    smtp_password = "glam qvdk tihb uonc"  # Tu contraseña
